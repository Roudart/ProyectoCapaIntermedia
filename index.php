...
<body>
    ...
    <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ffotografias.antena3.com%2Fclipping%2Fcmsimages02%2F2016%2F04%2F14%2F34306ACC-119A-43D7-86EC-FF7BC3C800A3%2F58.jpg&f=1&nofb=1" class="img-fluid rounded mx-auto d-block" alt="">
    ...
    <h1 class="text-center">Encuentra el curso para tí...</h1>
    ...
    <script>
        function BuscarCurso(e) {
            ...
            var sizeCurso = e.id.length;
            var idCurso = e.id.substring(9, sizeCurso);
            console.log(idCurso);
            var GetCurso = document.createElement("FORM");
            var InputId = document.createElement("INPUT");
            GetCurso.setAttribute("method", "get");
            GetCurso.setAttribute("action", "curso.php")
            GetCurso.hidden = true;
            InputId.setAttribute("id", idCurso);
            InputId.setAttribute("name", idCurso);
            GetCurso.appendChild(InputId);
            GetCurso.submit();
        }
    </script>
