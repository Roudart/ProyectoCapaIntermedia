...
$CursoReciente = $ConexionCursos->MasRecientes();
$ConexionBusqueda = new Conexion();
$Curso = $ConexionBusqueda->TraerCursos();
...
<body>
    ...
    <h1 class="text-center">Los ultimos cursos</h1>
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="list-1" role="tabpanel" aria-labelledby="list-1-list">
                        <?php if (isset($CursoReciente)) {
                            $sizeCursos = sizeof($CursoReciente);
                            for ($i = 0; $i < $sizeCursos; $i++) {
                                echo
                                ...
                                <div class="col-2">
                                    <img src="';
                                if ($CursoReciente[$i]["ImagenURL"] !== null) {
                                    echo $CursoReciente[$i]["ImagenURL"];
                                } else {
                                ...
                                <div class="col-10">
                                    <h1>' . $CursoReciente[$i]["Nombre"] . '</h1>
                                    <p>' . $CursoReciente[$i]["Descripción"] . '</p>
                                    <input type="text" id="CursoId" name="CursoId" value="' . $CursoReciente[$i]["IdCurso"] . '"  hidden>
                                    <button type="submit" id ="LinkCurso' . $CursoReciente[$i]["IdCurso"] . '" class="btn btn-secondary">Ver mas...</button>
                                    <span class="w3-badge w3-large w3-black w3-padding">Hace ' . $CursoReciente[$i]["Hace"] . '</span>
                                </div>
                            </div>
                            </form>
                            ';
