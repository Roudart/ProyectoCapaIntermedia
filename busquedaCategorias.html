                ...
                <div class="col-10">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="tab-cursos-populares" data-bs-toggle="tab" data-bs-target="#popular" type="button" role="tab" aria-controls="true">Los mas populares</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="tab-cursos-calificados" data-bs-toggle="tab" data-bs-target="#calificado" type="button" role="tab" aria-controls="true">Los mas populares</button>
                        </li>
                    </ul>

                    <div class="row" id="listaPopulares">
                        <div class="col-sm-3" id="cartaPopulares">
                            <div class="card">
                                <div class="card-body">
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="popular" role="tabpanel" aria-labelledby="tab-cursos-populares">
                                            <div class="card bg-dark text-white">
                                                ...
                                                <div class="card-img-overlay">
                                                    ...
                                                    <p class="card-text">Aprende todo sobre python</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="calificado" role="tabpanel" aria-labelledby="tab-cursos-calificados">Aqui van otros cursos</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <script>
                            for(var i=0; i<6; i++){
                            var carta = document.getElementById("cartaPopulares");
                            var cln = carta.cloneNode(true);
                            document.getElementById("listaPopulares").appendChild(cln);
                            }
