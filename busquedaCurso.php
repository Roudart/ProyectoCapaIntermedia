...
if (isset($_GET["InputBusquedaCurso"])) {
    $CursoNombre = $ConexionCursos->TraerCursoNombre($_GET["InputBusquedaCurso"]);
} else
    echo "Nada!";
            ...
            <div class="col">
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="list-1" role="tabpanel" aria-labelledby="list-1-list">
                        <?php if (isset($CursoNombre)) {
                            $sizeCursos = sizeof($CursoNombre);
                            for ($i = 0; $i < $sizeCursos; $i++) {
                                echo
                                ...
                                <div class="col-2">
                                    <img src="';
                                if ($CursoNombre[$i]["ImagenURL"] !== null) {
                                    echo $CursoNombre[$i]["ImagenURL"];
                                } else {
                                ...
                                <div class="col-10">
                                    <h1>' . $CursoNombre[$i]["Nombre"] . '</h1>
                                    <p>' . $CursoNombre[$i]["Descripción"] . '</p>
                                    <input type="text" id="CursoId" name="CursoId" value="' . $CursoNombre[$i]["IdCurso"] . '"  hidden>
                                    <button type="submit" id ="LinkCurso' . $CursoNombre[$i]["IdCurso"] . '" class="btn btn-secondary">Ver mas...</button>
                                </div>
                            </div>
                            </form>
                            ';
