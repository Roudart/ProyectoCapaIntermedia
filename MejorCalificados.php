...
$Curso = $ConexionCursos->MejorCalificados();
?>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <?php if (isset($Curso)) {
                            ...
                            for ($i = 0; $i < $sizeCursos; $i++) {
                                if($Curso[$i]["Promedio"] == null) $Curso[$i]["Promedio"] = '0.0';
                                echo
                                ...
                                <div class="col-10">
                                    ...
                                    <span class="w3-badge w3-large w3-yellow w3-padding">'.$Curso[$i]["Promedio"].'</span>
                                </div>
                            </div>
                            </form>
                            ';
